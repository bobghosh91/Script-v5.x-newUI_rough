...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/1_Action_Common/2_Company Selection/select_Company'), [('company') : 'Test2020 New'],FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'genericFunctions.DataProcessing.writeToSpecificCellIntoExcel'('Data Files\\Test-Input.xlsx', "Runtime", 
    GlobalVariable.currentTestCaseID, 'CatalogName', 'MajorSWCat' + commonFunctions.timeStamp)

CustomKeywords.'genericFunctions.DataProcessing.writeToSpecificCellIntoExcel'('Data Files\\Test-Input.xlsx', "Runtime", 
    '2', 'CatalogName', 'MajorSWCat' + commonFunctions.timeStamp)

CustomKeywords.'genericFunctions.DataProcessing.writeToSpecificCellIntoExcel'('Data Files\\Test-Input.xlsx', "Runtime", 
    GlobalVariable.currentTestCaseID, 'CatalogCode', 'CCMAG' + commonFunctions.timeStamp)
...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/3_Publisher/Catalog/Search_Catatog In Table'), [('catalogSearch') : CustomKeywords.'genericFunctions.DataProcessing.readTestDataFromExcelFile'(
           '1', 'CatalogName')], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/3_Publisher/Catalog/Publish - Verify Publish site'), [('siteName') : 'CicCloud'], FailureHandling.STOP_ON_FAILURE)
