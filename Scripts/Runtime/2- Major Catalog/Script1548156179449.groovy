...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authoring/Versions/New_Version_Major'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/3_Publisher/Catalog/Search_Catatog In Table'), [('catalogSearch') : CustomKeywords.'genericFunctions.DataProcessing.readTestDataFromExcelFile'(
            '1', 'CatalogName')], FailureHandling.CONTINUE_ON_FAILURE)
