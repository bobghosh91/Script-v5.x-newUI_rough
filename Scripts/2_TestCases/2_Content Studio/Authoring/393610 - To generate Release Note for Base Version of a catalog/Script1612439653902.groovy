...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/2_Content Studio/4_Author/Click_Release_Note'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(5)

WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/2_Content Studio/4_Author/Generate_Release_Note'), [:], FailureHandling.STOP_ON_FAILURE)
...
String strVer = WebUI.getText(findTestObject('1_Actions_AppSpecific/2_Content Studio/4_Author/subtitle_Version'))

String strDate = WebUI.getText(findTestObject('1_Actions_AppSpecific/2_Content Studio/4_Author/subtitle_Published_Date'))

String strnote = WebUI.getText(findTestObject('1_Actions_AppSpecific/2_Content Studio/4_Author/subtitle_Release_Note'))

CustomKeywords.'genericFunctions.Assertions.valueEqualityAssertion'(strVer, CustomKeywords.'genericFunctions.DataProcessing.readTestDataFromExcelFile'(GlobalVariable.currentTestCaseID, 'VersionText'), 'Expected and actual Version Text string not equal')

CustomKeywords.'genericFunctions.Assertions.valueEqualityAssertion'(strDate, currentDate, 'Expected and actual Published Date string not equal')

CustomKeywords.'genericFunctions.Assertions.valueEqualityAssertion'(strnote, CustomKeywords.'genericFunctions.DataProcessing.readTestDataFromExcelFile'(GlobalVariable.currentTestCaseID, 'Release Note'), 'Expected and actual currency string not equal')
