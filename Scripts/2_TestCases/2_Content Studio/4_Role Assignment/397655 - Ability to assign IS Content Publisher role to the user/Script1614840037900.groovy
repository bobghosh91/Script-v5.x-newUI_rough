...
CustomKeywords.'genericFunctions.Utilities.waitForObjectToBeVisible'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_Content-IS-publisher'))

try {
verifyChkbox = WebUI.verifyElementNotChecked(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_Content-IS-publisher'),
...
WebUI.click(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_Content-IS-publisher'))
...
CustomKeywords.'genericFunctions.Assertions.assertTestObjectTextIsPresentOnUi'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/a_IS Management'),'IS Management')

CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsClickable'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/a_IS Management'))

CustomKeywords.'genericFunctions.Utilities.waitForObjectToBeClickableAndClick'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/a_IS Management'))

CustomKeywords.'genericFunctions.Assertions.assertTestObjectTextIsPresentOnUi'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/a_Default Catalog'),'DEFAULT CATALOG')
