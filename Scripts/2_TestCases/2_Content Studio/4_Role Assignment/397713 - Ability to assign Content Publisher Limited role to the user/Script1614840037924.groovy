...
WebUI.verifyElementNotChecked(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_CS Automation'), GlobalVariable.maxWait, FailureHandling.STOP_ON_FAILURE)
...
CustomKeywords.'genericFunctions.Utilities.waitForObjectToBeVisible'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_Content Publisher Limited'))

WebUI.verifyElementNotChecked(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_Content Publisher Limited'), GlobalVariable.maxWait, FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'genericFunctions.Utilities.waitForObjectToBeClickableAndClick'(findTestObject('1_Actions_AppSpecific/2_Content Studio/5_Role Assignment/checkbox_Content Publisher Limited'))
...
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[@id='catalogs-list-view']")
...
//Check catalog table text
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[contains(text(),'Catalogs') and @class='card-header']")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectTextIsPresentOnUi'(tObj,'Catalogs')

//check versions table
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[@id='catalog-version-view']")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsVisible'(tObj)

//Check version table text
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[contains(text(),'Versions of') and @class='card-header']")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsVisible'(tObj)
...
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsNotVisible'(tObj,'New')
 
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[contains(text(),'Usage Analytics') and @class='btn btn-primary mr-2']")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsNotVisible'(tObj,'Usage Analytics')
 
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[contains(text(),'Access Requests') and @class='btn btn-secondary']")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsNotVisible'(tObj,'Access Requests')
 
tObj.addProperty('xpath', ConditionType.EQUALS, "//*[@id='generate-release-note-popup-btn' and contains(text(),'Release Notes')]")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsNotVisible'(tObj,'Release Notes')

tObj.addProperty('xpath', ConditionType.EQUALS, "//*[@class='cs-icon cs-icon-edit' and @data-catalogid='Xp0-cXJzdHU']")
CustomKeywords.'genericFunctions.Assertions.assertTestObjectIsNotVisible'(tObj,'icon edit')