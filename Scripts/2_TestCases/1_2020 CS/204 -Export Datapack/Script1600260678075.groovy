...
if (GlobalVariable.anyWebDriverSessionOpen.toString().equalsIgnoreCase("true")) {
...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authoring/Versions/Export_Datapack'), [:], FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'genericFunctions.Utilities.waitForChromeFileDownloadOnWindows'(System.getProperty("user.home")+"\\Downloads", ".zip", 30)