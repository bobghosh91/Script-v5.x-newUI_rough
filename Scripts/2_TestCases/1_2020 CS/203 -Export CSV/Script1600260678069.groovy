...
WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authoring/Versions/Export_CSV'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(GlobalVariable.minWait)

CustomKeywords.'genericFunctions.Utilities.waitForChromeFileDownloadOnWindows'(System.getProperty('user.home') + '\\Downloads', '.zip', 10)
