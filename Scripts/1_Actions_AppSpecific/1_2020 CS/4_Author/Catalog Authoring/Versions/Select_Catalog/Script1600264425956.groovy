...
if (browser.contains('firefox')) {
	WebUI.callTestCase(findTestCase('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authoring/Versions/Select_Catalog by Search'), [('catalogName') : selectCatalog], FailureHandling.STOP_ON_FAILURE)
 }else{


WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authring/Versions/select_Catalog'), selectCatalog, false,FailureHandling.CONTINUE_ON_FAILURE)

int index = WebUI.getNumberOfSelectedOption(findTestObject('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authring/Versions/select_Catalog'))
