...
/*WebUI.uploadFile(findTestObject('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authring/Versions/input_uploadPafToImport'),importPAF)

WebUI.delay(GlobalVariable.minuteDelay)*/

WebUI.click(findTestObject('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authring/Versions/input_uploadPafToImport'))

CustomKeywords.'appSpecificFunctions.fileUpload.dataImport'("Data Files\\ReferenceData\\" + GlobalVariable.currentTestCaseID, 'zip')

WebUI.click(findTestObject('1_Actions_AppSpecific/1_2020 CS/4_Author/Catalog Authring/Versions/button_Import PAF'))
