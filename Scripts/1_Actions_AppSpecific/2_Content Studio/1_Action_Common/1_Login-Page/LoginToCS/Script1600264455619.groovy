...
WebUI.callTestCase(findTestCase('0_Actions_General/appendFlagsToBaseUrlAndLaunch'), [('flagCombination') :"<doNotAppendAnything>", ('relaunchBrowser') : true
        , ('skipPrivacyPolicyMessage') : true], FailureHandling.STOP_ON_FAILURE)
